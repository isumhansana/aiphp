...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="../../index.php"><img src="../../imgs/favicon_io/favicon-32x32.png"
                    alt="Logo"></a>
                    ...
                    <div class="modal-body">
                        <form action="index.php?taskID=<?php echo ($taskID); ?>" method="POST">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="search" class="form-control" placeholder="Spotlight Search"
                                    aria-label="Spotlight Search" aria-describedby="basic-addon2">
